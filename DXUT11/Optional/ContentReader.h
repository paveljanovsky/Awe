...
public:
	...
	//Fields for storing texture2D data

	uint32_t texture2dHeight;
	uint32_t texture2dWidth;
	uint32_t texture2dMipCount;
	vector<uint8_t> texture2dMip0;

	//end texture2d fields
