...
bool ModelClass::LoadModel(char* filename)
{
	...
	m_vertexCount = data.vertexData.size() / 8; //vertexData is floats, each vertex is 8 floats
	...
	for(i=m_vertexCount-1; i >= 0; i--) //need to read xnb vertices backwards to make them compatible
	{
