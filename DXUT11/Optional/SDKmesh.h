...
public:
	...
	//virtual HRESULT                 Create( ID3D11Device* pDev11, string szFileName/*, bool bCreateAdjacencyIndices=
      //                                      false, SDKMESH_CALLBACKS11* pLoaderCallbacks=NULL*/ );
	virtual HRESULT CreateXnb( ID3D11Device* pDev11, string szFileName, bool bCreateAdjacencyIndices=
                                           false, SDKMESH_CALLBACKS11* pLoaderCallbacks=NULL );
