...
HRESULT ModelClass::Create( ID3D11Device* pDev11, LPCTSTR szFileName, bool bCreateAdjacencyIndices, SDKMESH_CALLBACKS11* pLoaderCallbacks)
{
	...
	//TODO:fix hardcoding
	Initialize(pDev11, "..\\media\\cube\\Cylinder.xnb", L"..\\media\\cube\\seafloor.dds");
...
HRESULT ModelClass::CreateXnb( ID3D11Device* pDev11, string szFileName, bool bCreateAdjacencyIndices, SDKMESH_CALLBACKS11* pLoaderCallbacks)
											{
	//char *s = (char*)malloc(1024 * sizeof(char));
	//strcpy(s, "HKEY_CURRENT_USER\\");
	//strcpy(s, (char*)szFileName);
	...
	//TODO:fix hardcoding
	Initialize(pDev11, (char*) szFileName.c_str(), L"..\\media\\cube\\seafloor.dds");
